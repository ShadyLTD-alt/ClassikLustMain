      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <textarea 
            ...
            rows={4} 
          />
          <p className="text-xs text-gray-500 mt-1">Example: Array of objects with upgradeId and minLevel</p>
        </div>
        ...
        <div>
          ...
          <textarea 
            ...
            rows={3} 
          />
          <p className="text-xs text-gray-500 mt-1">Example: Array of strings like character IDs or upgrade IDs</p>
        </div>
        ...
        <div>
          ...
          <textarea 
            ...
            rows={3} 
          />
          <p className="text-xs text-gray-500 mt-1">Example: Object with reward types and amounts</p>
        </div>
