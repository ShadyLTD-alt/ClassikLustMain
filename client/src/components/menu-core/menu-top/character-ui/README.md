...
```
client/src/components/menu-core/menu-top/character-ui/
...
**Usage:**
```tsx
import CharacterSelection from '@/components/menu-core/menu-top/character-ui/CharacterSelection';
...
**Usage:**
```tsx
import CharacterGallery from '@/components/menu-core/menu-top/character-ui/CharacterGallery';
...
### Why `menu-core/menu-top/character-ui/`?

- **menu-core** = Main game UI components
- **menu-top** = Top menu system (player info, boosts, character management)
- **character-ui** = All character-related player UI within top menu
